        ...
        while (true) {
            ...
            switch (n) {
                    ...
                    try (FileWriter fr = new FileWriter(file, true)) {
                        ...
                        for (int i = 0; i < fs.length - 1; i++) {
                            try {
                                ...
                                ms = String.format("%02d%02d%d%04d", nt.getDayOfMonth(), nt.getMonthValue(),
                ...
                case 1: {
                    ...
                    nt = LocalDate.now();
                    ms = String.format("%02d%02d%d%04d", nt.getDayOfMonth(), nt.getMonthValue(), nt.getYear(),TaiKhoan.dem);
                    pw = Integer.toString(CauHinh.rand.nextInt(900000) + 100000);
                    do {
